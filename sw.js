const CACHE='alimentacao-v14';
const ASSETS=['./','./index.html','./menu.html','./styles.css','./layout-fixes.css','./app.js','./version.js','./nutrition-data.js','./manifest.webmanifest','./icon-official-192.png','./icon-official-512.png','./apple-touch-icon.png','./favicon.png'];
