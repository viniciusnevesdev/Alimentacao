const CACHE='nutritrack-beta-v23';
const ASSETS=['./','./index.html','../layout-fixes.css','../version.js','./manifest.webmanifest','./app.js','./base-index.html','./base-app.js','./styles.css','./nutrition-data.js','./tab-animation.css','./tab-animation.js','./icon-beta-192.png','./icon-beta-512.png','./apple-touch-icon.png','./favicon.png'];
