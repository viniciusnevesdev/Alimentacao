const CACHE='nutritrack-beta-v9';
const ASSETS=['./','./index.html','../layout-fixes.css','./manifest.webmanifest','./app.js','./base-index.html','./base-app.js','./styles.css','./nutrition-data.js','./tab-animation.css','./tab-animation.js'];
